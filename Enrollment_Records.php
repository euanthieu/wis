...
<ul class="navigation-bar">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['enrolls_id'])) {
        ...
        if ($result->num_rows > 0) {
            ...
            <form method="POST" action="Enrollment_Records.php">
            ...
            <tr>
                <td><input type="date" name="enrolldates" value="<?php echo $editstudent['EnrollmentDate']; ?>"></td>
                <td><input type="text" name="enrollgrade" value="<?php echo $editstudent['Grade']; ?>"></td>
            </tr>
            <tr>
